...
- **Derive types from authoritative schemas.** When a protocol buffer, OpenAPI spec, GraphQL schema, database migration, or design-system token file defines a shape, derive from it instead of hand-rolling a parallel type. See the **principle-encode-lessons-in-structure** principle skill (`skill://principle-encode-lessons-in-structure`).
