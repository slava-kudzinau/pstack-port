...
- Path: OMP skill discovery is flat and non-recursive. For a new mode, use `.omp/skills/<handle>-mode/SKILL.md` in the project, or `~/.omp/agent/skills/<handle>-mode/SKILL.md` if the user prefers a personal, cross-project skill.
...
Apply the **unslop** skill (`skill://unslop`) to every line.
