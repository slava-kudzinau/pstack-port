...
Before spawning investigators, list the available MCP servers that this session exposes. Use the available-tools map when present. Otherwise inspect the MCP servers this project's own settings enable.
