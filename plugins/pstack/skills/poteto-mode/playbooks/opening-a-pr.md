...
- `## Verification`. State how you ran each check and its rigor. Name the real path, such as driving the terminal, driving the browser, or the targeted tests. State the outcome of each check, not only the command name.
