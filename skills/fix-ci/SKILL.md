...
metadata:
  ...
  status: 'portable'
  note: "Copied verbatim from the reference port (refs/ref-port/plugins/pstack/skills/fix-ci @ c2ade4b); cursor-team-kit component, not part of the pstack subtree, so it had no Phase A matrix row. The reference port's menu-description one-liner became our description; OMP has no menu-description slot."
---
