...
- `read` tool calls against any `SKILL.md` file (project `.omp/skills/`, user `~/.omp/agent/skills/`, or plugin-installed skills under `~/.omp/plugins/node_modules`)
